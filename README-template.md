# Frontend Mentor - Solução de aplicação de calculadora de idade

Esta é uma solução para o desafio da aplicação [Age calculator app challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/age-calculator-app-dF9DFFpj-Q). Os desafios do Frontend Mentor ajudam-no a melhorar as suas capacidades de codificação através da construção de projectos realistas.
...
- Ver uma idade em anos, meses e dias após a apresentação de uma data válida através do formulário
- Receber erros de validação se:
  - Qualquer campo estiver vazio quando o formulário for submetido
  - O número do dia não se situa entre 1-31
  - O número do mês não se situa entre 1-12
...
- **Bonus\***: Ver os números de idade animar para o seu número final quando o formulário é submetido
